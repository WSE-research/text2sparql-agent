...
The result of the final step should be the final SPARQL query over Freebase. Don't propose to execute the query.
At the end step you MUST output exactly **ONE** SPARQL query over Freebase string **without extra text or markdown**.
